...
#let init(body) = {
  titlepage(authors: (), city: "Санкт-Петербург", department: "Кафедра №1", documentName: "ОТЧЁТ ПО ПРАКТИЧЕСКОЙ РАБОТЕ №1", education: "ГУАП", group: "М412", teachers: ("Л.П. Вершинина",), position: "д-р техн. наук , доцент", object: "Математические основы систем управления", title: "Оценка наблюдаемого параметра по результатам измерений")
